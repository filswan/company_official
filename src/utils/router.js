const writer = (to) => {
    ...
    const creatArr = [{
        ...
        {
            name: "keywords",
            content: "We support our customers to meet their specific needs"
        },
        {
            name: "description",
            content: "Applying the world's leading distributed cloud leasing technology to the field of artificial intelligence, providing cost-effective machine learning, edge computing/private cloud and hybrid cloud services worldwide."
        },
        {
            property: "og:title",
            content: "Nebula AI"
        ...
        {
            property: "og:url",
            content: "https://nebula-ai.com/"
        },
        {
            property: "og:image",
            content: "https://nebula-ai.com/logo.png"
        },
        {
